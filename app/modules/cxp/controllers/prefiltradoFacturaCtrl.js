...
app.controller('prefiltradoFacturaCtrl', function ($scope, cxpService, serverConf, $http, $modal, modalService, localStorageService,$state, tempCache) {
    ...
    $scope.btnRegistrarFactura = '<button id="registrarFactura" type="button" height="5" class="btn btn-primary" ng-click="registrarFactura(row)" style="cursor: pointer;" data-placement="bottom" title="Registrar Factura">' +
    '<span class="glyphicon glyphicon-save-file"></span> Registrar Factura</button>';
    ...
    $scope.gridOptionsConceptos = {
      ...
      //  filterOptions:{filterText:'',useExternalFilter:false},
        ...
        columnDefs: [
            ...
            {displayName:"Acción",cellTemplate: $scope.btnRegistrarFactura, width: '15%', enableCellEdit: false},
        ]
    };
